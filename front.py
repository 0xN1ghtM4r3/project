...
def Scan_Page():
    ...
    button3 = customtkinter.CTkButton(master=frame6, text="Back", command=lambda: [des6(), WifiScan()],
                                      fg_color="transparent")
...
def FullScan():
    ...
    radio = customtkinter.CTkRadioButton(frame7, text="141.68.44.205", variable=radio_value, value="141.68.44.205")
    radio.pack(pady=(6, 3), padx=50, anchor="w")
    radio2 = customtkinter.CTkRadioButton(frame7, text="192.168.1.1", variable=radio_value, value="192.168.1.1")
    ...
    button3 = customtkinter.CTkButton(master=frame7, text="Select Drone", command=save_ip_address)
...
def Test():
    ...
    button3 = customtkinter.CTkButton(master=frame8, text="Back", command=lambda: [des8(), FullScan()],
                                      fg_color="transparent")
    button3.pack(pady=12, padx=10)
...
def CustomTest():
    ...
    button4 = customtkinter.CTkButton(master=frame9, text="Back", command=lambda: [des9(), Test()])
    button4.place(relx=0.15, rely=0.93, anchor=tkinter.CENTER)
